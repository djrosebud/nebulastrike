...
export class TouchControlsHudViewModel extends UiViewModel {
  ...
  // Space shooter fire button
  shootVisible: boolean = true;
  shootEnabled: boolean = true;
...
const BUTTON_CONFIGS: ButtonConfig[] = [
  ...
  {
    action: 'Shoot',
    geom: {right: 88, bottom: 870, w: 160, h: 160},
    geomLandscape: {right: 153, bottom: 590, w: 160, h: 160},
    momentary: false,
    passThrough: false,
    holdMode: TouchHoldMode.HoldUntilRelease,
    visibleKey: 'shootVisible',
    enabledKey: 'shootEnabled',
    pressedKey: 'shootPressed',
  },
  {
    action: 'Interact',
